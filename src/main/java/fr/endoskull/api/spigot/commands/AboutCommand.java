...
public class AboutCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        sender.sendMessage(Languages.getLang(sender).getMessage(MessageUtils.Global.ABOUT).replace("%line%", EndoSkullAPI.LINE).replace("%server%", Main.getInstance().getServer().getName()));
