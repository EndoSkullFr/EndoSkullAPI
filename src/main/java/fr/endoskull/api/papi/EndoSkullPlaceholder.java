...
public class EndoSkullPlaceholder extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, String identifier){
        ...
        if(identifier.equals("level")){
            return String.valueOf(new EndoSkullPlayer(player.getUniqueId()).getLevelWithXp());
        }
        if(identifier.equals("money") || identifier.equals("solde")){
            return String.valueOf(new EndoSkullPlayer(player.getUniqueId()).getMoney());
        }
