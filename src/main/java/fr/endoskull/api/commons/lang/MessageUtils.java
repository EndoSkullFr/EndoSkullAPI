...
public interface MessageUtils {
    ...
    enum Global implements MessageUtils {
        ...
        ANY_LOBBY, ANNOUNCEMENT, ANNOUNCEMENT_1, ANNOUNCEMENT_2, ANNOUNCEMENT_3, EZ_WARN, ANTI_SPAM, SERVER_STOP, STP_USAGE, REPORT_USAGE,
        REPORT_SEND, REPORT_SELF, VOTE_ERROR, NO_VOTE, VOTE_ALREADY, VOTE_CLAIM, VOTE_LOADING, SERVER_MAINTENANCE,
        VALID, UNCERTAIN, FALSE, REPORT_RESOLVED;
